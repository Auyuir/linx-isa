...
|`BSTART.CUBE` |32 |- |`BSTART.CUBE TileOP, DataType` |-
...
|`BSTART.TEPL` |32 |- |`BSTART.TEPL TileOp, DataType, <tile, gprs>` |-
|`BSTART.TMA` |32 |- |`BSTART.TMA TileOp, DataType` |-
|`BSTART.VPAR` |32 |- |`BSTART.VPAR <VS8, VS16>` |-
|`BSTART.VSEQ` |32 |- |`BSTART.VSEQ <VS8, VS16>` |-
|`BSTOP` |32 |- |`BSTOP` |-
