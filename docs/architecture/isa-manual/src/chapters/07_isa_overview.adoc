...
This chapter provides a narrative overview of the major instruction families in the v0.1 catalog. The complete,
...
vector semantics are outside the current bring-up scope unless specified by the golden sources (`isa/golden/v0.1/`); the instruction reference
chapter enumerates the encodings present in the v0.1 catalog.
