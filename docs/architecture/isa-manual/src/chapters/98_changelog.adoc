...
* Switched default compiled catalog to `isa/spec/current/linxisa-v0.3.json`.
* Kept `isa/spec/current/linxisa-v0.2.json` as legacy reference.
...
* Updated preamble to reference `isa/spec/current/linxisa-v0.3.json` as the single source of truth.
...
* Added staged v0.3 compiled catalog path: `isa/spec/v0.3/linxisa-v0.3.json`.
