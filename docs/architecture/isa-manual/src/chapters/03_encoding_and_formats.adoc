...
In the v0.1 catalog, mnemonic prefixes are used to distinguish families of encodings:
...
The authoritative encoding details live in `isa/spec/current/linxisa-v0.1.json`:
