...
- compiler compile-only tests (`/Users/zhoubot/linxisa/compiler/llvm/tests/`)
- QEMU runtime tests (`/Users/zhoubot/linxisa/tests/qemu/`)
- a small benchmark harness (`/Users/zhoubot/linxisa/workloads/benchmarks/`)
...
- Map each test ID to:
  - a directed unit test under `/Users/zhoubot/linxisa/tests/qemu/tests/` (runtime)
