...
The compile tests live in `compiler/llvm/tests` and generate:
...
```bash
CLANG=~/llvm-project/build-linxisa-clang/bin/clang TARGET=linx32-linx-none-elf OUT_DIR=./compiler/llvm/tests/out-linx32 ./compiler/llvm/tests/run.sh
```
