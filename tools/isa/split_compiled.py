...
def main() -> int:
    ...
    ap.add_argument("--spec", default="isa/spec/current/linxisa-v0.1.json", help="Compiled spec JSON path")
    ap.add_argument("--out", default="isa/golden/v0.1", help="Golden output directory")
    args = ap.parse_args()
