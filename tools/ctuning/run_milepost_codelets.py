...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Build and run ctuning Milepost codelets on Linx QEMU (bare metal).")
    parser.add_argument("--ctuning-root", default=str(Path.home() / "ctuning-programs"))
    parser.add_argument("--out-dir", default=str(REPO_ROOT / "tools" / "ctuning" / "out"))
